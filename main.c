...
float t = 0.0;
char indice_freq = 1;
char indice_freqOld = 1;
// END 2: PRIVATE INCLUDES
/* USER CODE END PV */
  ...
  *pt|=(1<<4);
  ...
  while (1)
  {
	  // BEGIN 5: USER CODE WHILE1
	 	  ...
	 	  //sprintf(xTouchStr,"X:%3d",g_ts.touchX[0]);
	 	  //BSP_LCD_DisplayStringAt(20,20,(uint8_t *) xTouchStr,LEFT_MODE);
	 	  //sprintf(xTouchStr,"Y:%3d",g_ts.touchY[0]);
	 	  //BSP_LCD_DisplayStringAt(20,50,(uint8_t *) xTouchStr,LEFT_MODE);
	 	  // BEGIN 5: USER CODE WHILE1
    /* USER CODE END WHILE */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PI0 BUTTON_Pin */
